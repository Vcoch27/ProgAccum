...
@vite('resources/css/components/cardQP.css')
@endpush
...
<section class="hero-section">
    <div class="card-grid">
        ...
        <a class="card" href="#">
            <div class="card__background" style="background-image: url('{{ asset("img/img_bg_pq/{$package->images}") }}')"></div>
            <div class="card__content">
                ...
                <div>
                    ...
                    <?php $rate =  $package->rating; ?>
                    <div class="star-rating" data-rating="{{ $rate }}">
                        <h4 class="gap-star">Rating: <span>{{ $rate }}</span></h4>
                    </div>
                </div>
                <button class="try-btn" onclick="window.location.href='{{ route('packages.show', $package->id) }}'">Start</button>
                <h5>Your highest score: <span>6.7/10</span></h5>
            </div>
        </a>
        @endforeach
